...
<head>
    ...
    style="width:50px;height:50px;margin-right:10px;">
        ...
        <?php endif; ?>
        <h1 id="main-title">Relatório Geral</h1>
            <table class="table" id="trabalhos-table">
                ...
                <tbody>
                    <?php foreach($trabalhos as $trabalho):?>
                        <tr>
                            <td style="padding: 0 10px;" scope="row" class="nome"><?=$trabalho['nome']?></td>
                            <td style="padding: 0 10px;" scope="row"><?=$trabalho['data']?></td>
                            <td style="padding: 0 10px;" scope="row"><?=$trabalho['material']?></td>
                            <td style="padding: 0 10px;" scope="row"><?=$trabalho['titulo']?></td>
                            <td style="padding: 0 10px;" scope="row"><?=$trabalho['cliente']?></td>
                            <td style="padding: 0 10px;" scope="row">R$ <?=$trabalho['valor']?></td>
                        </tr>
                    <?php endforeach?>    
                </tbody>
            </table>
